[to Japanese](https://github.com/arimuratak/Conograph-powder-auto-indexing-/blob/main/README-jp.md)

# Instructions for Conograph CUI program
[Version 0.99](https://github.com/arimuratak/Conograph-powder-auto-indexing-/tree/main/Conograph1_0_00_win) is the initial release of the core program of the Conograph software which executes powder auto-indexing by the method introduced in [[2](#References)], [[3](#References)] for the first time.

![outline](https://github.com/arimuratak/Conograph-powder-auto-indexing-/assets/149344913/cdc8a78a-3fd3-4ff4-bf08-83795c4005ec)
```
...
- [Tips for powder auto-indexing using Conograph](https://github.com/arimuratak/Conograph-powder-auto-indexing-/blob/main/Conograph1_0_00_win/doc/TipsForPowderAutoIndexing.md) (link to another web page)
...
1. The Conograph program requires the following three input files. (Examples can be found in the sample folder.)
    - A *.inp.xml file that includes information about the input parameters ([Example](https://github.com/arimuratak/Conograph-powder-auto-indexing-/blob/main/Conograph1_0_00_win/sample/sample5/Cimetidine-SR.inp.xml))
    - A cntl.inp.xml that includes the names of the *.inp.xml file and the output file ([Example](https://github.com/arimuratak/Conograph-powder-auto-indexing-/blob/main/Conograph1_0_00_win/sample/sample5/cntl.inp.xml))
    - An IGOR text file that includes a powder diffraction pattern (X and Y coordinates and the error in Y) and the following information about peaks ([Example](https://github.com/arimuratak/Conograph-powder-auto-indexing-/blob/main/Conograph1_0_00_win/sample/sample5/Cimetidine-SR_pks.histogramIgor). This file is outputted from the [peak search program](https://github.com/arimuratak/PeakSearch/tree/main) distributed separately)
...
1. Until you terminate Conograph by entering quit, you can enter the number associated with any of the unit cells in the XML file as many times as you want. Before termination, Conograph outputs the following:
    - an XML file including information about refined unit-cell parameters and zero-point shifts ([Example](https://github.com/arimuratak/Conograph-powder-auto-indexing-/blob/main/Conograph1_0_00_win/figures/sample2.index2.xml))
    - an IGOR text file unifying the IGOR text files output during refinement ([Example](https://github.com/arimuratak/Conograph-powder-auto-indexing-/blob/main/Conograph1_0_00_win/figures/sample2_lattices.histogramIgor))
...
![flowchart](https://github.com/arimuratak/Conograph-powder-auto-indexing-/assets/149344913/cad4833b-0500-4f9f-b64b-957c20c79e11)
